...
export default {
    ...
    mounted() {
        ...
        const navigationButton = document.getElementsByClassName('navigation__links')[0].children
...
<template>
    <font-awesome-icon v-if="!this.navigationActive" icon="fa-solid fa-bars" class="icon" @click="toggleMenu" size="2x" />
    <font-awesome-icon v-else icon="fa-solid fa-xmark" class="icon" @click="toggleMenu" size="2x" />
