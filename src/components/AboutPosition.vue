...
export default {
  ...
  methods: {
    handleScroll() {
      this.containerTopAboutMe = document
        .getElementsByClassName("about-container__about-me")[0]
        .getBoundingClientRect().top;
      this.containerTopWorkExperience = document
        .getElementsByClassName("about-container__my-work-experience")[0]
        .getBoundingClientRect().top;
      this.containerTopEducation = document
        .getElementsByClassName("about-container__my-education")[0]
        .getBoundingClientRect().top;
      this.scrollPosition = Math.abs(this.containerTopAboutMe - this.padding);
      this.scrollPercentage = Math.round(
        (this.scrollPosition / this.travelDistance) * 100
      );
      ...
      const canvasPositionLineHeight = Math.min(
        this.canvasLineHeight,
        Math.round(canvasLinePercentage * this.scrollPercentage)
      );
      ...
      if (
        canvasPositionLineHeight >= 0 &&
        canvasPositionLineHeight <= this.circle2Position
      ) {
      ...
      if (
        canvasPositionLineHeight >= this.circle2Position &&
        canvasPositionLineHeight <= this.circle3Position
      ) {
    ...
    handleThemeChange() {
      ...
      this.canvasColor = getComputedStyle(
        document.documentElement
    ...
    handleResize() {
      ...
      this.containerTopEducation = document
        .getElementsByClassName("about-container__my-education")[0]
        .getBoundingClientRect().top;
      this.containerBottomEducation = document
        .getElementsByClassName("about-container__my-education")[0]
        .getBoundingClientRect().bottom;

      //Get the canvas elements
      this.containerCanvas =
        document.getElementsByClassName("position-container")[0];
      this.canvasLineHeight = document
        .getElementsByClassName("canvas__line")[0]
        .getBoundingClientRect().height;
      this.canvasLineWidth = document
        .getElementsByClassName("canvas__line")[0]
        .getBoundingClientRect().width;
      this.canvasPositionLine = document.getElementsByClassName(
        "canvas__line__position"
      )[0];
      this.canvasCircle1 = document.getElementsByClassName("canvas__circle")[0];
      this.canvasCircle1Text = document.getElementsByClassName(
        "position-container__text__about-me"
      )[0];
      this.canvasCircle2 = document.getElementsByClassName("canvas__circle")[1];
      this.canvasCircle2Text = document.getElementsByClassName(
        "position-container__text__work-experience"
      )[0];
      this.canvasCircle3 = document.getElementsByClassName("canvas__circle")[2];
      this.canvasCircle3Text = document.getElementsByClassName(
        "position-container__text__education"
      )[0];
      ...
      this.contentHeight =
        this.containerBottomEducation - this.containerTopAboutMe;

      //Calculate the positions of the container
      const workExperiencePosition = Math.round(
        ((this.containerTopWorkExperience - this.containerTopAboutMe) /
          this.contentHeight) *
          100
      );
      const educationPosition = Math.round(
        ((this.containerTopEducation - this.containerTopAboutMe) /
          this.contentHeight) *
          100
      );
      ...
      const canvasCircle2Percentage =
        workExperiencePosition * this.canvasLinePercentage;
      const canvasCircle2Top =
        canvasCircle2Percentage - this.circleDiameter / 2 + "px";
      const canvasCircle3Percentage =
        educationPosition * this.canvasLinePercentage;
      const canvasCircle3Top =
        canvasCircle3Percentage - this.circleDiameter / 2 + "px";
      const canvasCircleLeft =
        -this.circleDiameter / 2 + this.canvasLineWidth / 2 + "px";
      ...
      const canvasCircle1TextMiddle =
        this.canvasCircle1Text.getBoundingClientRect().top;
      const canvasCircle2TextMiddle =
        this.canvasCircle2Text.getBoundingClientRect().top;
      const canvasCircle3TextMiddle =
        this.canvasCircle3Text.getBoundingClientRect().top;

      //Calculate the middle of the circles on the line
      const canvasCircle1Middle =
        this.canvasCircle1.getBoundingClientRect().top -
        this.canvasCircle1.getBoundingClientRect().height / 2;
      const canvasCircle2Middle =
        this.canvasCircle2.getBoundingClientRect().top -
        this.canvasCircle2.getBoundingClientRect().height / 2;
      const canvasCircle3Middle =
        this.canvasCircle3.getBoundingClientRect().top -
      ...
      const canvasCircle1Difference =
        canvasCircle1Middle - canvasCircle1TextMiddle;
      const canvasCircle2Difference =
        canvasCircle2Middle - canvasCircle2TextMiddle;
      const canvasCircle3Difference =
        canvasCircle3Middle - canvasCircle3TextMiddle;
      ...
      this.travelDistance =
        this.containerBottomEducation -
        this.containerTopAboutMe -
  ...
  mounted() {
    if (this.settings.screenWidth < 768) {
      document.getElementsByClassName("position-container")[0].style.display =
        "none";
    } else {
      this.handleResize();
      this.handleThemeChange();
...
<template>
  <div class="position-container">
    <div class="position-container__text">
      <div class="position-container__text__about-me" @click="scrollTo(1)">
        {{ about.canvasMe }}
      </div>
      <div
        class="position-container__text__work-experience"
        @click="scrollTo(2)"
      >
        {{ about.canvasExperience }}
      </div>
      <div class="position-container__text__education" @click="scrollTo(3)">
        {{ about.canvasEducation }}
      </div>
    </div>
    <div class="canvas">
